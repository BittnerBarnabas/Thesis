...
\subsubsection{Shared Pointer Conversion Check}
\par To summarise in a nutshell the matcher part of the check, it's looking for \verb|CallExpr|s involving such functions that have a \verb|shared_ptr| as argument and a constructor-conversion is taking place at the place of function call. \medskip
