...
\par Installing the tool on Microsoft Windows is a little bit more complicated than on simple Linux. There are 2 paths that you can take to set up a Linux environment inside Windows. 
\paragraph{MinGW}
\paragraph{WSL}
\subsubsection{Linux}
